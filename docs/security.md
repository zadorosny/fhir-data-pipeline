...
- Dependabot está desabilitado; bumps de dependência são manuais, guiados pelos alertas do `pip-audit`/Trivy.
...
```bash
# 1. Gere a nova chave (url-safe base64 de 32 bytes aleatorios; só stdlib)
